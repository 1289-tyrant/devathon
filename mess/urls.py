...
urlpatterns = [
    ...
    path('mess/<str:mess>/attendence/', views.attendence, name="attendence"),
    path('mess/<str:mess>/attendence/updateattendence/', views.updateattendence, name="updateattendence"),
]